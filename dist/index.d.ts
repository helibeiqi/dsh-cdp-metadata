...
export { loadSources, type LoadedCapability, type LoadResult, type LoadSourcesConfig } from './loader.js';
export { resolveSafe, readCdpFile, walkCdpFiles, MAX_FILE_BYTES, MAX_DEPTH, MAX_FILES } from './fs-utils.js';
export type { CdpDocument, CdpCapability, Identity, Boundaries, CognitiveStyle, Output, DownstreamHint, SideEffects, Cost, Runtime, ToolSchema, Archetype, ReasoningType, UncertaintyExpression, FailureMode, SideEffectLevel, ComputeLevel, MonetaryModel, ValidationLevel } from './types.js';
import { apply } from './integration.js';
/** 默认导出：cordis 插件形态 */
